      ...
      <section className='bg-indigo-700 py-20 mb-4'>
        ...
        >
          <div className='text-center'>
            ...
            >Become a React Dev</h1>
            <p
              className='my-4 text-xl text-white'
            >Find the React Job that fits your skills and needs</p>
          </div>
        </div>
      </section>
      <section className='py-4'>
        <div className='container-xl lg:container m-auto'>
          <div className='grid grid-cols-1 md:grid cols-2 gap-2 gap-4 p-4 rounded-lg'>
            ...
            <div className='bg-indigo-100 p-6 rounded-lg shadow-md'>
              ...
              <p className='mt-2 mb-4'>List your job to find the perfect developers for the role</p>
              <a
                href="/add-job.html"
